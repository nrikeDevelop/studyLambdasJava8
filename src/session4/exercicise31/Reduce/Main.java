package session4.exercicise31.Reduce;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		//REDUCE COGE EL STREAM Y LOS COMBINA MEDIANTE LA ACCION REPETIDA
		int suma = rooms.stream().map(room->room.getCapacity()).reduce(0, Integer::sum);
